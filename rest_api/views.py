...
from rest_api.serializers import (
    ...
    InputValidationserializer,
    LoginRequestValidationSerializer,
    MoviesSerializer,
...
def api_login_session_auth(request):
    try:
        ...
        if request_info.is_valid():
            ...
            return Response(
                {"message": "Invalid Input", "errors": request_info.errors},
                status=status.HTTP_400_BAD_REQUEST,
            )
...
def update_movie(request):
    try:
        ...
        if request_info.is_valid():
            ...
            return Response(
                {
                    "updated_movie_details": movie_serialized,
...
def create_movie(request):
    try:
        ...
        if request_info.is_valid():
            ...
            return Response(
                {
                    "movie_created": movie_created_serialized,
