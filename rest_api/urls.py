...
urlpatterns = [
    ...
    path(
        "movie_detail_view/", rest_api_views.movie_detail_view, name="movie_detail_view"
    ),
    ...
    path(
        "input_validation_with_serializer/",
        rest_api_views.input_validation_with_serializer,
        name="input_validation_with_serializer",
    ),
    # session authentication using CSRFToken
    path(
        "api_login_session_auth/",
        rest_api_views.api_login_session_auth,
        name="api_login_session_auth",
    ),
    # Token Authentication using generated Token
    path(
        "api_login_token_auth/",
        rest_api_views.CustomAuthToken.as_view(),
        name="api_login_token_auth",
    ),
    # JWT authentication
...
forms_testing = [path("form1/", rest_api_views.form1, name="form1")]
