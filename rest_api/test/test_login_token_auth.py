...
class TestTokenAuth(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.username , self.password, self.email = 'testuser', 'testpassword', 'testuser@gmail.com'
    ...
    def test_get_all_movies_protected_view(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION=f'Token {self.login_response.data['token']}')
